...
urlpatterns = [
    ...
    path("calendar/auth-url/", views.calendar_auth_url, name="integration-calendar-auth-url"),
    path("calendar/callback/", views.calendar_callback, name="integration-calendar-callback"),
