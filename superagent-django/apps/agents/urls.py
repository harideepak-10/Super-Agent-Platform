...
urlpatterns = [
    ...
    path("templates/<int:template_id>/", views.agent_template_detail, name="agent-template-detail"),
    path("templates/<int:template_id>/activate/", views.agent_template_activate, name="agent-template-activate"),
    ...
    path("<uuid:pk>/overview/", views.agent_overview, name="agent-overview"),
