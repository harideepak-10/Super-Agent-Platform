...
- When describing an invoice's amount in a summary, always use the TOTAL / grand total figure
  (the final amount due, after any tax/GST is added) — never the pre-tax subtotal. If
